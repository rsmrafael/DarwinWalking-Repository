...
void BodyAction::circleRight(){
	...
	int16_t x = config->get<int16_t>("Body", "circleRightX", -40);
	int16_t y = config->get<int16_t>("Body", "circleRightY", 50);
	int16_t r = config->get<int16_t>("Body", "circleRightR", 70);
	bool turningAim = config->get<bool>("Body", "circleRightTurningAim", false);
...
void BodyAction::circleLeft(){
	ConfigFile *config = Config::getInstance();
	int16_t x = config->get<int16_t>("Body", "circleLeftX", -40);
	int16_t y = config->get<int16_t>("Body", "circleLeftY", -70);//Bot4: -65
	int16_t r = config->get<int16_t>("Body", "circleLeftR", -50);
	bool turningAim = config->get<bool>("Body", "circleLeftTurningAim", false);
	setWalkerCommand(x, y, r, turningAim);
