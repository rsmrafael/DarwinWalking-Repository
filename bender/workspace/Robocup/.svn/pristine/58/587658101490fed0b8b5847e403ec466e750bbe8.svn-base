...
/**
 * DT_INIFile class provides methods for manipulating (Read/Write) windows ini files.
 * 
 * @author Prasad P. Khandekar
 * @version 1.0
 * @since 1.0
 */
public final class DT_INIFile
{
     ...
     */
    @SuppressWarnings("unchecked")
	public DT_INIFile(String pstrPathAndName)
    {
 ...
 *----------------------------------------------------------------------------*/
     ...
     * @param pstrFmt the format string.
 ...
 *----------------------------------------------------------------------------*/
     ...
     */
    public static void main(String[] pstrArgs) throws IOException
    {
        DT_INIFile objINI = null;
        String  strFile = null;
        ...
        objINI.save();
        objINI.notepad(strFile);
        objINI = null;
        
    }
    
    /**
     * Show the entries of an ini-file with notepad.exe.
     * @param file the name of the work file.
     */
    private void notepad(String file) throws IOException
    {
        Runtime r = Runtime.getRuntime();
        r.exec("notepad.exe" + " " + file );
    }
