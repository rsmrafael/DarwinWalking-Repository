...
enum BodyAction_StaticMotion {
  ...
  BodyAction_StaticMotion_KickBall = 81,
  BodyAction_StaticMotion_KickForward = 82,
  BodyAction_StaticMotion_KickSideward = 83,
  BodyAction_StaticMotion_KickBackward = 84,
  BodyAction_StaticMotion_KickToTarget = 85,
  BodyAction_StaticMotion_KickAdvanced = 86
};
...
class BodyAction : public ::google::protobuf::MessageLite {
 public:
  ...
  static const StaticMotion KickForward = BodyAction_StaticMotion_KickForward;
  static const StaticMotion KickSideward = BodyAction_StaticMotion_KickSideward;
  static const StaticMotion KickBackward = BodyAction_StaticMotion_KickBackward;
