...
int main(int argc, char *argv[])
{
    ...
    } else if (argc == 4)
    {
        ...
        printf("Creating the LinesFinder class\n");
        LinesFinder flines(&flims);

        printf("Finding the lines\n");
        flines.FindLines(rgb_image);

        //printf("Drawing the lines found\n");
        //flines.DrawLines(rgb_image);

        printf("Filtering the pole candidates\n");
        flines.FindPoleCandidates();

        printf("Drawing the pole candidates\n");
        ...
        printf("Creating the line finder class\n");
        LinesFinder flines(&flims);
        ...
        while (!quit)
        {
            ...
            //printf("Capturing a frame from the camera\n");
