...
void BallDetection::configChanged()
{
	...
	mDebugDrawings 		= Config::GetInt("Vision", "Ball_debugDrawings", 0);
	...
	mMaxFieldlineError = Config::GetInt("Vision", "Ball_maxFieldlineError", 15);//5

	mRadiusCompareWeight 		= Config::GetDouble("Vision", "Ball_radiusCompareWeight", 0.01);
	mCircleAnomalyCompareWeight = Config::GetDouble("Vision", "Ball_circleAnomalyCompareWeight", 12.0);//22//20//18//20
	...
	mMaxAnomalyRadiusFactor		= Config::GetDouble("Vision", "Ball_maxAnomalyRadiusFactor", 0.35);//0.22
	mMinRadius 					= Config::GetInt("Vision", "Ball_minRadius", 3);//6//3//4//2

	mMinY = Config::GetInt("Vision", "Ball_minY",  50);
	mMaxU = Config::GetInt("Vision", "Ball_maxU", 130);
	mMinV = Config::GetInt("Vision", "Ball_minV", 160);//140
