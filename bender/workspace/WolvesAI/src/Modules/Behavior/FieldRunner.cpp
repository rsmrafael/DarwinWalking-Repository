...
void FieldRunner::configChanged()
{
	...
	mMoveTiltAngle = config->get<int>("FieldRunner", "moveTiltAngle", 50);
	mTurnFieldBorderMinY = config->get<int>("FieldRunner", "turnFieldBorderMinY", 10);
	mTurnTime = config->get<int>("FieldRunner", "turnTime", 2000);
	mCheckFieldBorderX = config->get<int>("FieldRunner", "checkFieldBorderX", 620);
	mCheckFieldBorderMaxY = config->get<int>("FieldRunner", "checkFieldBorderMaxY", 10);
	mTurningXMovement 	= config->get<int16_t>("AI", "turningXMovement", 0);
	mMoveForwardX 	= config->get<int16_t>("FieldRunner", "moveForwardX", 100);
	mMoveForwardY 	= config->get<int16_t>("FieldRunner", "moveForwardY", 0);
}
