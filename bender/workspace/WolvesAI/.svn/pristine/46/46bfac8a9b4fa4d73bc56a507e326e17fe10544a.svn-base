...
void Scanlines::configChanged() {
	...
	mScanlineDistanceColumn		= Config::GetInt("Vision", "scanlineDistanceColumn", 3);
	mScanlineDistanceRow		= Config::GetInt("Vision", "scanlineDistanceRow", 3);
	mMinCloudDistance 			= Config::GetInt("Vision", "minCloudDistance", 10);
	...
	mFieldLineScanDivisor		= Config::GetInt("Vision", "fieldLineScanDivisor", 4);
	mMaxGreenNotSeen 			= Config::GetInt("Vision", "maxGreenNotSeen", 50);
	...
	mNumGreenSearchPoints = Config::GetValue<size_t>("Vision", "numGreenSearchPoints", (size_t)10);
