...
BEGIN_DECLARE_MODULE(GoalSideHistogramPredictor)
	...
	//REQUIRE(HistogramVector,OpponentGoalHistograms)
	//REQUIRE(HistogramVector,OwnGoalHistograms)
	REQUIRE(HistogramList,OpponentGoalHistograms)
	REQUIRE(HistogramList,OwnGoalHistograms)
