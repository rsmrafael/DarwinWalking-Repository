...
void Object::copyTo(Object &obj) const {
	obj.lastImageTopLeftX = lastImageTopLeftX;
	obj.lastImageTopLeftY = lastImageTopLeftY;
	obj.lastImageX = lastImageX;
	obj.lastImageY = lastImageY;
	obj.lastImageWidth = lastImageWidth;
	obj.lastImageHeight = lastImageHeight;
	obj.lastImageSeen = lastImageSeen;
	obj.matched = matched;
	obj.type = type;
	obj.lastSeenCounter = lastSeenCounter;
	obj.originalHeight = originalHeight;
	obj.originalWidth = originalWidth;
}
