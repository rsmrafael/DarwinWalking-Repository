...
void TauraWalking::Process()
{
	...
	// Desired position
    m_Rx = Omniwalk::GetInstance()->GetRx();
    m_Ry = Omniwalk::GetInstance()->GetRy();
	m_Rz = Omniwalk::GetInstance()->GetRz();
	m_Rroll = Omniwalk::GetInstance()->GetRroll();
	m_Rpitch = Omniwalk::GetInstance()->GetRpitch();
	m_Ryaw = Omniwalk::GetInstance()->GetRyaw();
    m_Lx = Omniwalk::GetInstance()->GetLx();
    m_Ly = Omniwalk::GetInstance()->GetLy();
	m_Lz = Omniwalk::GetInstance()->GetLz();
	m_Lroll = Omniwalk::GetInstance()->GetLroll();
	m_Lpitch = Omniwalk::GetInstance()->GetLpitch();
	m_Lyaw = Omniwalk::GetInstance()->GetLyaw();
